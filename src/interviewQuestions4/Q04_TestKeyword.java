...
*/
    public static void main(String[] args) {
        ...
        cevaplarıKarsılastır(answers,keys);


    }

    private static void cevaplarıKarsılastır(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i <answers.length ; i++) {
            ...
            System.out.println((i+1)+" nolu ogrencının "+dogruSayısı+" dogru cevabı var.");
        }
    }
